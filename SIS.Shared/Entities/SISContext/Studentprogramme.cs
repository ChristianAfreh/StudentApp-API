...
namespace SIS.Shared.Entities.SISContext
{
    public partial class Studentprogramme
    {
        ...
        public virtual Classparameter Classparameter { get; set; }
        public virtual Feeclassification Feeclassification { get; set; }
        public virtual Programmeoption Programmeoption { get; set; }
        public virtual Programmestream Programmestream { get; set; }
        public virtual Student Student { get; set; }
        public virtual Pgstudentthesistopic Pgstudentthesistopic { get; set; }
