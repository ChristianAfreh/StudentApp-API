...
namespace SIS.Shared.Extensions
{
    ...
    class StoredProcedureResponse
    {
        ...
        public string ResultMessage { private get; set; }

        public bool ResultKey { private set; get; }

        public KeyValuePair<bool, string> Response
        {
            get
            {
                return new KeyValuePair<bool, string>(ResultKey, ResultMessage);
            }
        }
    }
}
